...
$wpsc_version = 169;
$wpsc_fix_164 = 1;
$wp_cache_debug_username = '87e57a7781c4774ccfb75d4df78bec87';
$wp_cache_mobile_groups = '';
$cache_page_secret = 'd12b1b98bce2e69b573cdeee759b0cc7';
$wp_cache_home_path = '/';
...
$cache_acceptable_files = array ( 0 => 'wp-comments-popup.php', 1 => 'wp-links-opml.php', 2 => 'wp-locations.php', 3 => 'manage', );

$cache_rejected_uri = array ( 0 => 'wp-.*\\.php', 1 => 'index\\.php', 2 => '/manage/', 3 => 'ads.txt', );
...
$wp_cache_debug_ip = '';
$wp_cache_debug_log = 'ea41d0a2ba2b840ca5337c4c04214492.php';
